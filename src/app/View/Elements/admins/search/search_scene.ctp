...
$lesson = $this->Form->input('lesson_id', array('options' => $lessons, 'id' => 'selectLesson', 'value' => isset($lesson_id) ? $lesson_id : '', 'empty' => '--Select--', 'div' => false, 'label' => false, 'class' => 'form-control input-sm select2'));
$unit = $this->Form->input('unit_id', array('options' => $units, 'id' => 'selectUnit', 'value' => isset($unit_id) ? $unit_id : '', 'empty' => '--Select--', 'div' => false, 'label' => false, 'class' => 'form-control input-sm select2'));
