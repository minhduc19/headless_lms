...
$title = $this->Form->input("$model_name.title", array('class' => 'form-control input-sm', 'label' => false, 'div' => false, 'required' => true));

$thumb_url = $this->Form->input("Image.thumb", array('type' => 'file', 'default' => '', 'class' => 'form-control txtmedium image', 'id' => 'thumb-image', 'div' => FALSE, 'label' => FALSE));
$thumb_preview = $this->HtmlExtend->get_image_from_link($item[$model_name]['thumb'], array('id' => 'thumb-image-preview', 'alt' => 'thumb image', 'width' => 84));
                    ...
                    <div>
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane" id="chapters">
                                <?php echo $this->element('admins/default/course-chapters', array('input' => $item['Chapter'])) ?>
                            </div>
                        </div>
                    </div>
