...
<div class="row">
    <div class="col-md-12">
        ...
        <?php echo $this->Form->create($model_name, array('class' => 'form-horizontal form-row-seperated', 'id' => 'editForm', 'url' => array('controller' => 'admins', 'action' => 'edit', $item[$model_name]['id']))) ?>
        <div class="portlet">
