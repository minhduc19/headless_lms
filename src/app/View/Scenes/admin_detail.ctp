...
$course = $this->Form->label("$model_name.course", isset($course) ? $course['title'] : '', array('class' => 'control-label', 'label' => false));
$lesson = $this->Form->label("$model_name.lesson", isset($lesson) ? $lesson['title'] : '', array('class' => 'control-label', 'label' => false));
$unit = $this->Form->label("$model_name.unit", $item['Unit']['title'], array('class' => 'control-label', 'label' => false));
...
$type = $this->Form->label("$model_name.type", $item[$model_name]['type'], array('class' => 'control-label', 'label' => false));
...
$arrInput = array(
    ...
    array('label' => __('Unit'), 'input' => $unit),
