...
$btn_detail_action = 'teacher_detail';
$btn_edit_action = 'teacher_edit';
$btn_delete_checked_action = 'teacher_delete_checked';
?>
            ...
            <div class="portlet-body">
                <div class="table-container">
                    <div class="datatable_products_wrapper" class="dataTables_wrapper dataTables_extended_wrapper no-footer">
                        <?php echo $this->Form->create(FALSE, array('url' => ['action' => 'index', 'admin' => false, 'teacher' => true], 'inputDefaults' => array('label' => false), 'novalidate' => true, 'class' => 'form-horizontal form-row-seperated', 'type' => 'GET')); ?>
			<?php echo $this->element('admins/search/teacher_search_scene'); ?>
                        <div class="row">
                                    ...
                                    if (!empty($items)) {
                                        foreach ($items as $item) {
                                            ...
                                            <tr role="row" class="filter">
                                                ...
                                                <td>
                                                    <?php echo !empty($item['TeacherLesson']) ? $item['TeacherLesson']['title'] : ''; ?>
                                                </td>
                                                ...
                                                <td class="action-control">
                                                    ...
                                                    echo $this->Html->link('<i class="fa fa-trash-o"></i>' . __('&nbspDelete'), array('action' => 'teacher_delete', $item[$model_name]['id']), array('class' => 'btn default btn-xs btn-calling-ajax', 'data-confirm' => __('Are you sure?'), 'escape' => false, 'data-container' => "#{$arrParam['action']}-ajax-message"));
                                                    ?>
                                                </td>
                                                <!-- END CHANGE HERE -->
                                            </tr>
...
<script>
    $(function() {
        ...
        $(".sort-order").change(function(){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo $this->Html->url(array('controller' => 'scenes', 'action' => 'teacher_ajax_update_order')); ?>",
                data: {
                    sort_order: order,
                    id: scene_id
                },
