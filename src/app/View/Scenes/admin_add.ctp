...
$lesson = $this->Form->input("$model_name.lesson_id", array('options' => [], 'empty' => '-- Select --', 'id' => 'selectLesson', 'class' => 'form-control input-sm select2', 'label' => false, 'div' => false, 'required' => false));
$unit = $this->Form->input("$model_name.unit_id", array('options' => [], 'empty' => '-- Select --', 'id' => 'selectUnit', 'class' => 'form-control input-sm select2', 'label' => false, 'div' => false, 'required' => true));
