                                ...
                                <table class="table table-striped table-bordered table-hover" id="datatable_products">
                                    <thead>
                                        <tr role="row" class="heading">
                                            ...
                                            <th>
                                                <?php echo $this->Filter->sort_link(__('Short Order'), "$model_name.sort_order") ?>
                                            </th>
                                        ...
                                        foreach ($items as $item) {
                                            ...
                                            <tr role="row" class="filter">
                                                ...
                                                <td class="action-control">
                                                    <?php
                                                    echo $this->Html->link('<i class="fa fa-leanpub"></i>' . __('&nbspLessons'), array('controller' => 'lessons', 'action' => 'teacher_index', '?' => ['skill_id' => $item[$model_name]['id']]), array('class' => 'btn default btn-xs green', 'div' => false, 'label' => false, 'escape' => false, 'title' => __('Lessons')));
