...
<html>
    <head>
        <title><?= $item['Lesson']['title'];?></title>
        <meta charset="utf-8">
        <meta name="description" content="<?= strip_tags($item['Lesson']['short_description'])?>">
        <meta name="fragment" content="!">
        <meta content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=0" name="viewport">
        <link rel="shortcut icon" type="image/png" href="/favicon.ico">
        <meta name="author" content="NEcampus Limited">
        <meta property="og:type" content="website">
        <meta property="og:title" content="<?= $item['Lesson']['title'];?>">
        <meta property="og:image" content="<?= $preview_image;?>">
        <meta property="og:description" content="<?= strip_tags($item['Lesson']['short_description']);?>">
            ...
            <div class="download">
                <div class="row">
                    ...
                    <?php } else {
                        ...
                        <div class="col-xs-12 col-md-12 col-lg-12 btn-download">
                            <a class="button" href="necampus://lesson/<?= $item['Lesson']['id']; ?>">
