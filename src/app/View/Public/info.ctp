...
<html>
    <head>
        <title><?= $item['Teacher']['name'];?></title>
        <meta charset="utf-8">
        <meta name="description" content="<?= strip_tags($item['Teacher']['description'])?>">
        <meta name="fragment" content="!">
        <meta content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=0" name="viewport">
        <link rel="shortcut icon" type="image/png" href="/favicon.ico">
        <meta name="author" content="NEcampus Limited">
        <meta property="og:type" content="website">
        <meta property="og:title" content="<?= $item['Teacher']['name'];?>">
        <meta property="og:image" content="<?= $preview_image;?>">
        <meta property="og:description" content="<?= strip_tags($item['Teacher']['description']);?>">
    ...
    <body>
        <div class="container text-center">
            <div class="qrcode">
                <div class="row">Scan QR code from NEcampus to view teacher detail</div>
                <img src="<?= $share_image?>"/>
            </div>
            <div class="download">
                <div class="row">
                    ...
                    <?php } else {
                        ...
                        <div class="col-xs-12 col-md-12 col-lg-12 btn-download">
                            <a class="button" href="necampus://teacher/<?= $item['Teacher']['id']; ?>">
