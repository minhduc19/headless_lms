...
$chapter = $this->Form->input("$model_name.chapter_id", array('options' => [], 'id' => 'selectChapter', 'class' => 'form-control input-sm select2', 'label' => false, 'div' => false, 'required' => true));
                    ...
                    <div>
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane" id="units">
                                <?php echo $this->element('admins/default/lesson-units', array()) ?>
                            </div>
                        </div>
                    </div>
