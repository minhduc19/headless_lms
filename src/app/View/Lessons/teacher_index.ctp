...
<div class="row" id='<?php echo $arrParam['action'] ?>'>
    ...
    <div class="col-md-12">
        ...
        <div class="portlet">
			...
			<?php echo $this->element('admins/search/teacher_search_lesson'); ?>
                        <div class="row">
                                        ...
                                        foreach ($items as $item) {
                                            ...
                                            <tr role="row" class="filter">
                                                ...
                                                <td class="action-control">
                                                    ...
                                                    echo $this->Html->link('<i class="fa fa-trash-o"></i>' . __('&nbspDelete'), array('action' => 'teacher_delete', $item[$model_name]['id']), array('class' => 'btn default btn-xs btn-calling-ajax', 'data-confirm' => __('All related scenes will be deleted! Are you sure want to continue?'), 'escape' => false, 'data-container' => "#{$arrParam['action']}-ajax-message"));
                                                    ?>
                                                </td>
                                                <!-- END CHANGE HERE -->
                                            </tr>
